...
#if defined(CONFIG_STM_FAMILY_STXH410)
	/* use the "newer", smaller (more compact) address-space */
#	define AHB2STBUS_OHCI_BASE_OFFSET	0x00003c00
#	define AHB2STBUS_EHCI_BASE_OFFSET	0x00003e00
#	define AHB2STBUS_WRAPPER_GLUE_BASE	(CONFIG_SYS_USB_BASE + 0x00000000)
#	define AHB2STBUS_OHCI_BASE		(CONFIG_SYS_USB_BASE + AHB2STBUS_OHCI_BASE_OFFSET)
#	define AHB2STBUS_EHCI_BASE		(CONFIG_SYS_USB_BASE + AHB2STBUS_EHCI_BASE_OFFSET)
